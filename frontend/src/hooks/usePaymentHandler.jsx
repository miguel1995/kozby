...
export default function usePaymentHandler() {
    ...
    const onSubmit = async () => {
        try {
            ...
            const createdTransaction = await postTransaccion({
            ...
            const transactionId = createdTransaction.id || createdTransaction._id?.toString?.();
            clearOrder();
            if (transactionId) {
                navigate(`/resultado-pago/${transactionId}`);
            } else {
